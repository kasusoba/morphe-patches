...
public class ScreenBuilder {
    ...
    public void buildMiscSection() {
        ...
        if (SettingsStatus.copyGifKeywordButton) {
            addPreference(
                    helper.switchPreference(
                            str("kasusoba_copy_gif_keyword"),
                            str("kasusoba_copy_gif_keyword_desc"),
                            Settings.COMMENT_COPY_GIF_KEYWORD_BUTTON
                    )
            );
        }
        if (SettingsStatus.copyGiphyLinkButton) {
            addPreference(
                    helper.switchPreference(
                            str("kasusoba_copy_giphy_link"),
                            str("kasusoba_copy_giphy_link_desc"),
                            Settings.COMMENT_COPY_GIPHY_LINK_BUTTON
                    )
            );
        }
